...
| FSMO | File System Music Organizer | In progress (5/10) | 93.80% | [todo](FSMP.lib/FSMO/todo.md) |
| FSMP.Tests | Test suite | Complete (v1) | -- | [todo](FSMP.Tests/todo.md) |

**Overall coverage**: 96.36% | **Tests**: 808 all passing | **Build**: Passing
...
**Status**: 5/10 slices complete | **Next**: Slice 6 -- File Organizer (Copy Mode)
