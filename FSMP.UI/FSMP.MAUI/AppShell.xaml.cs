...
public partial class AppShell : Shell
{
    ...
    public AppShell()
    {
        ...
        Routing.RegisterRoute("manageDirectories", typeof(Pages.Settings.ManageDirectoriesPage));
        Routing.RegisterRoute("scanLibrary", typeof(Pages.Settings.ScanLibraryPage));
